...
Our two [core values](what-is-FikaWorks-Collective.html) "Freedom" and "Heart over Wallet" can sometimes collide. For example when it comes to which industries we work in. Some Crispers feel very strongly against the arms industry and the surveillance industry - for them, "Heart over Wallet" means avoiding those industries even if it means a loss of profit, and they don't want to associate with a consulting company that works with these industries.
...
To maintain a [happy home](what-is-FikaWorks-Collective.html) with mutual respect, we've agreed on this compromise:
